...
articleRouter.get("/:id", authMiddleware, (req: Request, res: Response, next: NextFunction)=>articleController.getArticle(req, res, next));
articleRouter.get("/", authMiddleware, (req: Request, res: Response, next: NextFunction)=>articleController.getArticles(req, res, next));
